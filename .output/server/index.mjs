globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'vue-bundle-renderer/runtime';
import { stringify as stringify$1, uneval } from 'devalue';
import { renderToString, ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrInterpolate } from 'vue/server-renderer';
import { renderSSRHead } from '@unhead/ssr';
import { promises, existsSync } from 'fs';
import { dirname, resolve, join } from 'path';
import { version, unref, inject, hasInjectionContext, getCurrentInstance, createApp as createApp$1, effectScope, reactive, useSSRContext, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, shallowReactive, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, withCtx, mergeProps, nextTick, defineComponent, computed, ref, h, Suspense, Transition, watchEffect, watch as watch$1, createTextVNode, toDisplayString, resolveComponent } from 'vue';
...
const errorHandler = (async function errorhandler(error, event) {
  ...
  const res = !isErrorPage ? await useNitroApp().localFetch(withQuery(joinURL(useRuntimeConfig$1().app.baseURL, "/__nuxt_error"), errorObject), {
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Title of your website","htmlAttrs":{"lang":"en"}};
...
function publicAssetsURL(...path) {
  const publicBase = useRuntimeConfig$1().app.cdnURL || useRuntimeConfig$1().app.baseURL;
...
const renderer = defineRenderHandler(async (event) => {
  ...
  const ssrContext = {
    url,
    event,
    runtimeConfig: useRuntimeConfig$1(),
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => Promise.resolve().then(function () { return index4e1a6f1e; }).then((m) => m.default || m)
  }
];
...
const AppComponent = _sfc_main$2$1;
const _sfc_main$1$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => Promise.resolve().then(function () { return error404B48eadfc; }).then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => Promise.resolve().then(function () { return error5004d2add16; }).then((r) => r.default || r));
...
const _sfc_main$3 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => Promise.resolve().then(function () { return islandRenderer32021951; }).then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
const RootComponent = _sfc_main$3;
if (!globalThis.$fetch) {
...
let entry;
{
  entry = async function createNuxtAppServer(ssrContext) {
    const vueApp = createApp$1(RootComponent);
...
const styles = {
  "node_modules/@nuxt/ui-templates/dist/templates/error-404.vue": () => Promise.resolve().then(function () { return error404Styles_1e0dde27$1; }).then(interopDefault),
  "node_modules/@nuxt/ui-templates/dist/templates/error-500.vue": () => Promise.resolve().then(function () { return error500Styles_cf4b3e80$1; }).then(interopDefault)
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h1>Header</h1><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam aut aliquid eos in fugiat minima nam harum voluptas mollitia, non, quod culpa labore corrupti, inventore odio. Quia voluptatibus voluptate consequatur.</p></div>`);
}
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender]]);

const index4e1a6f1e = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: index
});
...
const error404B48eadfc = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: error404
});
...
const error5004d2add16 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: error500
});
...
const islandRenderer32021951 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const error404Styles_1e0dde27$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: error404Styles_1e0dde27
});
...
const error500Styles_cf4b3e80$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: error500Styles_cf4b3e80
});
